...
// Test for cookies
var cookiepage = 'www.staples.com/sbd/content/help/cookieerror.html';
...
if ((!document.getElementById) && cookies['UnsupportedBrowser'] != 'True' && redirectpage.length <=0  && thispage.indexOf(cookiepage) < 0 ) {
	redirectpage = "www.staples.com/sbd/cre/resources/browserupgrade/index.html";
}
else if ((!document.getElementById) && cookies['UnsupportedBrowser'] != 'True' && thispage.indexOf(cookiepage) < 0 && redirectpage.length > 0 ) {
	redirectpage = "www.staples.com/sbd/cre/resources/browserupgrade/cookies.html";
}
